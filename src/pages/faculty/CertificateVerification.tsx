...
const mockCertificates: Certificate[] = [
  { id: '1', studentName: 'John Doe', registerNumber: 'RA2211003010', section: 'A', driveLink: '#', mlStatus: 'verified', facultyStatus: 'pending', mlScore: 95 },
  { id: '2', studentName: 'Jane Smith', registerNumber: 'RA2211003015', section: 'A', driveLink: '#', mlStatus: 'verified', facultyStatus: 'legit', mlScore: 98 },
];
